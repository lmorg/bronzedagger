...
var (
	status_code map[int]string = map[int]string{
		000: "Runtime error: unexpected error (misc)",
		001: "Runtime error: empty response",
		002: "Runtime error: too many open files",
		003: "Runtime error: connection reset by peer",
		004: "Runtime error: connection refused",
		005: "Runtime error: unexpected end of file",
		006: "Runtime error: connection timed out",
		100: "Continue",
