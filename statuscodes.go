...
var (
	status_code map[int]string = map[int]string{
		0:   "Runtime error: unexpected error (misc)",
		1:   "Runtime error: empty response",
		2:   "Runtime error: too many open files",
		3:   "Runtime error: connection reset by peer",
		4:   "Runtime error: connection refused",
		5:   "Runtime error: unexpected end of file",
		6:   "Runtime error: connection timed out",
		7:   "Runtime error: use of closed network connection",
		8:   "Runtime error: request canceled while waiting for connection",
		100: "Continue",
	...
	status_desc map[int]string = map[int]string{
		0:   "Runtime error: unexpected error (misc)",
		1:   "Runtime error: empty response",
		2:   "Runtime error: too many open files",
		3:   "Runtime error: connection reset by peer",
